...
const Post = ({ allPage, pageNumber, prev, next, currentPage, filterProduct }) => {
    ...
    return (
        <section>
            <Container>
                ...
                <div className="flex flex-wrap gap-2">
                    ...
                    {filterProduct.length > 12 && showAll ?
                        <div className="text-center">
                            <h2 onClick={handleShowAll} className='font-lato cursor-pointer bg-[#4368fe] text-[20px] text-[#fff]'>Show More</h2>
                        </div>
                        :
                        filterProduct.length > 12 &&
                        <div className="text-center">
                            <h2 onClick={handleLess} className='font-lato cursor-pointer bg-[#4368fe] text-[20px] text-[#fff]'>Show Less</h2>
                        </div>
                    }
                    </>
                :
                ...
                <Pagination pageNumber={pageNumber} prev={prev} next={next} currentPage={currentPage} />
                </>
                }
            </Container>
        </section>
