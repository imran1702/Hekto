                ...
                <div className="hidden md:block">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-5">
                            ...
                            {/* ⭐️ লজিক পরিবর্তন: লগইন স্টেট অনুযায়ী টেক্সট দেখানো */}
                            <Link to="/dashboard">
                                <div className="flex items-center">
                                    {/* loggedInUser যদি থাকে (null না হয়) তাহলে My Account দেখাবে */}
                                    <p>{loggedInUser ? (loggedInUser.displayName || 'My Account') : 'Login'}</p> 
                                    <RiContactsLine />
                                </div>
                            </Link>
