            ...
            <Container>
                <div className="w-full md:w-2/3 lg:w-1/3 mx-auto">
                    ...
                    <p className="text-[17px] text-[#9096B2] font-medium font-lato pb-6 text-center">
                        {user ? `Welcome, ${user.displayName || user.email}! You are logged in.` : 'Please fill the information below or use social media to create your account.'}
                    </p>
                    ...
                    <div className="text-center mb-6">
                        ...
                        <button 
                            ...
                            className="py-2 px-6 bg-[#db4437] text-white font-bold rounded-[5px] hover:bg-[#a3332a] mr-4 transition duration-200"
                        >
                            Google 🌐
                        </button>
                        <button 
                            onClick={handleFacebookLogin}
                            className="py-2 px-6 bg-[#4267B2] text-white font-bold rounded-[5px] hover:bg-[#32518e] transition duration-200"
                        >
                            Facebook 📘
                        </button>
                    </div>
