...
import { cartItemRemove, clearCartItem, decrement, increment } from '../slices/productSlice'
            ...
            <div className='lg:w-2/3 w-full pb-12 lg:pb-0'>
              <table className='w-full'>
                      ...
                      <th className='text-start text-[#1D3178] text-[14px] font-medium font-josefin py-4'>
                        <div className='flex items-center gap-x-2 sm:gap-x-4'>
                          <div className='relative'>
                            ...
                            <div onClick={()=>dispatch(cartItemRemove(i))} className='absolute top-[-8px] right-[-8px]'>
                              <IoMdClose
                      ...
                      <th className='text-start text-[#1D3178] text-[8px] sm:text-[14px] font-medium font-josefin px-2 sm:px-8'>
                        <div className='flex items-center gap-x-2'>
                          <button className='cursor-pointer'>
                            {item.qun > 1 ? <FaMinus onClick={()=>dispatch(decrement(i))} /> : <RiDeleteBin6Line onClick={()=>dispatch(cartItemRemove(i))} />}
                          </button>
                          <p className='text-[#15245E] text-[8px] sm:text-[16px] font-bold font-josefin'>{item.qun}</p>
                          <button onClick={()=>dispatch(increment(i))} className='cursor-pointer'>
                            <FaPlus />
                          </button>
                        </div>
                      </th>
                ...
                <div className='flex justify-between items-center pt-8'>
                  ...
                  <div>
                      <button onClick={()=>dispatch(clearCartItem())} className='text-[16px] font-semibold font-josefin bg-[#FB2E86] rounded-[5px] px-8 py-2 text-white cursor-pointer'>
                      Clear Curt
                      </button>
                  </div>
                </div>
                ...
                <table className='bg-[#F4F4FC] w-full rounded-[5px]'>
                  <tbody>
                    ...
                    <tr className='border-b-2 border-[#E8E6F1]'>
                      ...
                      <th className='py-6 text-start'>$1555</th>
                    </tr>
                    <tr>
                ...
                <div className='grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-x-4'>
                    ...
                    <div className='shadow-lg mb-4'>
                      <div className='relative group overflow-hidden'>
                        <Link to="" target='_top'>
                          <img src="" alt="" className='rounded-t-[5px]' />
                        </Link>
                        <div className='absolute -left-15 group-hover:left-2 bottom-8 opacity-0 group-hover:opacity-100 transition-all ease-in-out duration-500'>
                          <div className='pb-4'><AiOutlineShoppingCart className='text-[#fff] cursor-pointer hover:text-gray-200 text-[37px] shadow-2xl shadow-black p-1 rounded-full' /></div>
                      ...
                      <div className='bg-[#F7F7F7] px-2 sm:flex justify-between items-center py-4'>
                        <h4 className='text-[12px] text-[#151875] font-josefin font-semibold pb-2 sm:pb-0'>Arfoz</h4>
                        <div className='flex items-center gap-x-4'>
                          <p className='text-[12px] text-[#151875] font-josefin font-semibold'>$12</p>
                          <p className='line-through text-[12px] text-[#FB2448] font-josefin font-semibold'>$15</p>
                        </div>
                      </div>
                    </div>
