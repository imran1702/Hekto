...
import blogBottom from "../../assets/blogBottom.png";
...
const Blog = () => {
  ...
  let [blogProduct, setBlogProduct] = useState([]);
  let [blogFilterPro, setBlogFilterPro] = useState([]);
  ...
  useEffect(() => {
    ...
    let blogItems = blogProduct.slice(0, 4);
    setBlogFilterPro(blogItems);
  }, [data]);
  return (
      ...
      <Container>
        <div className="grid grid-cols-3">
          <div className="col-span-2">
            <div className="mb-8">
              <div>
                <img src={blogTop} alt="" className="w-full" />
              </div>
              <div className="flex items-center gap-x-10">
                <div className="flex items-center gap-x-2 py-4">
                  <FaPenFancy className="text-red-500" />
                  <p className="text-[#151875] text-[14px] font-bold font-josefin bg-[#FFE7F9] px-6">
                    Surf Auxion
                  </p>
                </div>
                <div className="flex items-center gap-x-2 py-4">
                  <LuCalendarDays className="text-[#FFA454]" />
                  <p className="text-[#151875] text-[14px] font-bold font-josefin bg-[#FFECE2] px-6">
                    Aug 09 2020
                  </p>
                </div>
              </div>
              <h2 className="text-[#151875] text-[30px] font-bold font-josefin py-2">
                Mauris at orci non vulputate diam tincidunt nec.
              </h2>
              <p className="text-[#151875] text-[16px] font-medium font-lato leading-[30px]">
              ...
              {aShow && (
                <p className="text-[#151875] text-[16px] font-medium font-lato leading-[30px]">
                  Repellat minus reiciendis ipsam odio obcaecati hic fugit
                  repudiandae velit, iure harum debitis illum rerum placeat
                  provident.
                </p>
              )}
              <button
            ...
            <div className="mb-8">
              <div>
                <img src={blogMiddle} alt="" className="w-full" />
              </div>
              <div className="flex items-center gap-x-10">
                <div className="flex items-center gap-x-2 py-4">
                  <FaPenFancy className="text-red-500" />
            ...
            <div className="mb-8">
              <div>
                <img src={blogBottom} alt="" className="w-full" />
              </div>
              <div className="flex items-center gap-x-10">
                <div className="flex items-center gap-x-2 py-4">
                  <FaPenFancy className="text-red-500" />
          ...
          <div className="pl-12">
            <div className="">
              <div className="max-w-[270px] pb-8">
                <h2 className="text-[#151875] font-bold font-josefin text-2xl pb-2">
                  Search
                </h2>
              ...
              <div>
                <h2 className="text-[#151875] font-bold font-josefin text-2xl pb-4">
                  Categories
                </h2>
                <div className="grid grid-cols-2">
                  {aCategory.map((cat) => (
                    <div className="text-[18px] text-[#3F509E] font-bold font-josefin py-2 pl-3 hover:bg-[#F939BF] hover:text-white hover:rounded-[5px]">
                      {cat.name} ({cat.count})
                    </div>
                  ))}
                </div>
                ...
                {blogFilterPro.map((item) => (
                  <Link to="/products">
                    <div className="flex gap-x-2 my-6">
                      ...
                      <div>
                        <h2 className="text-[16px] text-[#3F509E] font-bold font-jose pb-1">
                          {item.name}
                        </h2>
                        <p className="text-[11px] text-[#8A8FB9] font-bold font-lato">
                          Aug 09 2020
                        </p>
                      </div>
                    </div>
              ...
              <div className="pb-8">
                ...
                <div className="flex gap-x-2 pb-6">
                  <div>{/* <img src={sol1} alt="" /> */}</div>
                  <div>
                    <h2 className="text-[16px] text-[#3F509E] font-bold font-josefin pb-1">
